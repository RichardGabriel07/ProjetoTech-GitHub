    ...
    <body>
        ...
        <main id="gerenciar">
            ...
            <section class="section_gerenciar" id="curso">
                <h2><i class="fas fa-book card-icon"></i> Ver e Permitir Cursos Presenciais</h2>
                <a href="gerenciar_matriculas.php" class="button">Ver e Permitir Cursos Presenciais </a>
            </section>
